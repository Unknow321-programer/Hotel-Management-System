...
public class HomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.black));
        ...
        jPanel3.setBackground(new java.awt.Color(153, 204, 255, 220));
        ...
        jLabel11.setText("<HTML> Email:- saurabhbaban20@gmail.com<br><br> Phone:- +91 9881823127<br><br> Addr. A.M College");
        jLabel11.setVerticalAlignment(javax.swing.SwingConstants.TOP);

        jLabel12.setFont(new java.awt.Font("Gloucester MT Extra Condensed", 0, 20)); // NOI18N
        jLabel12.setText("<HTML> Hotel management is really about overseeing every<br> operation of the property. This requires<br> knowledge of distribution strategy, finance,<br> customer service, staff management, and more.</HTML>");
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 550, 1060, 150));

        jLabel8.setBackground(new java.awt.Color(255, 255, 255));
        jLabel8.setFont(new java.awt.Font("Monotype Corsiva", 1, 60)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Welcome To Our ");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 210, 396, -1));

        jLabel9.setFont(new java.awt.Font("Magneto", 1, 65)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 51, 0));
        jLabel9.setText("Hotel");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 290, 219, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 1060, 490));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/bg1.jpeg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1060, 700));
        
        setIconImage(new ImageIcon("Images/logo.jfif").getImage());
    ...
    protected void jLabel4MouseEnterd(MouseEvent e) {
        ...
        jLabel4.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.black));
    }
    ...
    protected void jLabel5MouseEnterd(MouseEvent e) {
        ...
        jLabel5.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.black));
    }
    ...
    protected void jLabel3MouseEnterd(MouseEvent e) {
        ...
        jLabel3.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.black));
